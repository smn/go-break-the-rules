...
function BreakTheRules() {
    ...
    self.add_state(new ChoiceState(
        'programming_language',
        'framework',
        'Thanks! We\'re looking for an intern. Which programming language do you prefer?',
        [
    ...
    self.add_state(new EndState(
        ...
        'name',
        {
            on_enter: function(state) {
                ...
                p.add_callback(function() {
                    return self.send_sms(im, (
                        'Dial *120*8864*1117# to try again.' +
                        'Also dial *120*8864*1105# for Google maps directions ' +
                        'or *120*8864# for Wikipedia'), im.user_addr);
                });
